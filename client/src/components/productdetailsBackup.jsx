            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              <div className="lg:w-1/2 w-full h-auto object-cover object-center rounded">
                ...
                <div className=" grid grid-cols-4 gap-4 mt-4">
                    <img src={import.meta.env.VITE_API_URL + product.attributes.image1.data.attributes.url} alt="product image" className="w-full cursor-pointer border"/>
                    <img src={import.meta.env.VITE_API_URL + product.attributes.image2.data.attributes.url} alt="product image" className="w-full cursor-pointer border"/>
                    <img src={import.meta.env.VITE_API_URL + product.attributes.image3.data.attributes.url} alt="product image" className="w-full cursor-pointer border"/>
                    <img src={import.meta.env.VITE_API_URL + product.attributes.image4.data.attributes.url} alt="product image" className="w-full cursor-pointer border"/>
                </div>
              </div>
