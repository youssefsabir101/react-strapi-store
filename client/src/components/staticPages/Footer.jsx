      ...
      <footer className="bg-violet-700 rounded-tl-[100px] shadow-2xl">
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="flex justify-center font-extrabold text-2xl text-white sm:justify-start">
                <h1>SabDecor</h1>
              </div>
            ...
            >
              ...
              <div className="text-center sm:text-left">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  ...
                  <li>
                    ...
                    >
                      <span
                        className="text-gray-200 transition group-hover:text-gray-200/75"
                      >
                        Live Chat
                      </span>
                      ...
                      <span className="relative flex h-3 w-3">
                        <span
                          className="absolute inline-flex h-full w-full animate-ping rounded-full bg-white/40 opacity-75"
                        ></span>
                        <span
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-gray-50">Contact Us</p>

                <ul className="mt-8 space-y-4 text-sm  justify-start items-start">
                  <li>
                    <a
                    ...
                    >
                      <svg
                        ...
                        className="h-5 w-5 shrink-0 text-gray-50"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="2"
                      ...
                      <span className="flex-1 text-gray-200">contact.support@sabdecor.com</span>
                    </a>
                  </li>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="flex-1 text-gray-200">+212 6 47 ** ** 43</span>
                    </a>
                  </li>
          ...
          <div className="mt-12 border-t border-gray-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              <p className="text-sm text-gray-100">
                ...
                <a
                  className="inline-block text-white underline transition px-2"
                  href="/"
                >
                  Terms & Conditions
                </a>
