    ...
    <div className="px-4 py-4 mx-auto  md:max-w-full  md:px-4 lg:px-8 fixed w-full z-10 bg-white">
      <div className="relative flex items-center justify-between">
        ...
        <ul className=" items-center hidden space-x-8 md:flex">
          ...
          <li>
            <Link to="/product-details" aria-label="Cart" title="cart" className="font-medium tracking-wide text-violet-700 transition-colors duration-200 hover:text-deep-purple-accent-400">
              details
            </Link>
          </li>
        </ul>
