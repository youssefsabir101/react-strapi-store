...
function Cart() {
  ...
  //get card item from (redux store)
  ...
  const subtotals = products.map(product => {
    const quantity = quantities[product.id] || 1; // Get quantity from Redux state
    return product.price * quantity; // Calculate subtotal for each item
  });

  // Calculate the total price by summing up all subtotals and adding VAT and discount
                                  ...
                                  <div className="grid grid-cols-2">
                                      ...
                                      <div className="flex flex-2 items-center justify-end gap-2">
                                        ...
                                        <button onClick={()=>dispatch(removeFromCart({
                                            ...
                                            className="h-8 w-12 rounded border-none bg-red-600 p-0 text-center text-white transition hover:bg-red-700"
                                          >
